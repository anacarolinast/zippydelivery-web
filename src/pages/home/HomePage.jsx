...
function HomePage() {
  ...
  useEffect(() => {
    axios
      .get(`${apiUrl}/empresa/usuario/` + localStorage.getItem("id"))
    ...
    <div className="h-fit justify-center p-24 bg-white">
      ...
      <div className="flex flex-col space-y-8 w-full h-full p-10">
        <div className="flex gap-5 border border-sky-100 p-2 justify-start">
          <div className="flex">
            <img
              className="h-fit self-center rounded-full"
              style={{ resizeMode: "cover", height: 240, width: 240 }}
              src={empresaImgPerfil}
            ...
            <div className="flex pt-2 justify-between">
              <div className="flex flex-col space-y-2">
                <div className="flex flex-row gap-2">
                  <img
                    className="h-auto mt-2 max-w-xs self-start"
                    src="check.png"
                    alt="Desempenho"
                  />
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="flex flex-row gap-10 justify-between"></div>
              </div>
            </div>
          </div>
        ...
        <div className="flex flex-row">
          <div className="flex h-fit justify-center">
            <span className="text-center w-1/2">
              Além disso, mantenha-se no comando dos pedidos, rastreie suas
              entregas, aceite ou recuse-os com simplicidade e eficiência. É o
              seu negócio, sob seu controle.
            </span>
          </div>
          <div className="flex h-fit justify-center">
            <span className="text-center w-1/2">
        ...
        <div className="flex flex-row gap-10 justify-center">
          <div
            className="flex bg-orange-100 rounded-lg h-fit p-4 cursor-pointer items-center gap-5"
            onClick={() => {
              navigate("/menu-manager");
            }}
          >
            <img src="gerenciar-cardapio.png" alt="Gerenciar Cardápio" />
            <span className="text-light-100 text-2xl font-bold text-center">
              Gerencie o cardápio
            </span>
          </div>
          <div
            className="flex bg-tomato-300 rounded-md h-fit p-4 cursor-pointer justify-center items-center gap-5"
            onClick={() => {
